...
#It accepts the hours worked and the hourly pay rate as
#arguments. The gross pay is displayed
def calc_pay_with_OT(hours, rate):
    ...
    print(f'The gross pay is ${format(gross_pay, ".2f")}', sep =" " )

#The calc_regular_pay function calculates pay with no overtime
#It accepts the hours worked and the hourly pay rate
#as arguments. The gross pay is displayed.
