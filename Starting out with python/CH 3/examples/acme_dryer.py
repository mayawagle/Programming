...
#The main function performs the program
def main():
...
#The start_up message function displays the 
...
#The step one function displaye the instructions for step 1
def step1():
...
#The step 3 function displays the instructions for step 3
def step3():
    print('Step 3: Remove the back panel')
    print('from the dryer.')
    print()

#The step 4 function displays the instructions for step 4
def step4():
